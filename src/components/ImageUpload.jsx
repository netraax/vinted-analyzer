...
import { processText } from '../utils/text_cleaner'; // Importation de la fonction de nettoyage
...
export default function ImageUpload() {
  ...
  const handleImageUpload = async (event) => {
    ...
    try {
      ...
      console.log("Données reçues avant nettoyage:", result);
      ...
      const cleanedData = processText(result.data.text || '');
      console.log("Données nettoyées:", cleanedData);

      setData({
        ...result.data,
        cleanedText: cleanedData.cleanedText, // Ajout des données nettoyées
      });
    } catch (error) {
